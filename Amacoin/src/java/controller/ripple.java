 ...
 * @author Alexis
 */
public class ripple extends HttpServlet {
    private static final String vue = "/WEB-INF/ripple.jsp";
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        boolean insert = this.panierDAO.insertPanierXRP(idPanier,nombre);
        if(insert)
