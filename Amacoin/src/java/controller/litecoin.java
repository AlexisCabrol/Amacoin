 ...
 * @author Alexis
 */
public class litecoin extends HttpServlet {
    private static final String vue = "/WEB-INF/litecoin.jsp";
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        boolean insert = this.panierDAO.insertPanierLTC(idPanier,nombre);
        if(insert)
